...
export default function Modal({ name, address, pincode, phoneNumber, setName, setAddress, setPincode, setPhoneNumber, Order }) {
        ...
        <>
            <div className="  text-center rounded-lg text-white font-bold">
                <button
                    type="button"
                    onClick={openModal}
                    className="w-48 bg-green-500 py-2 text-center rounded-lg text-white font-bold"
                >
                    Order now
                </button>
            </div>
                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <button onClick={()=>{Order(); closeModal()}} type="button" className="focus:outline-none w-full text-white bg-green-500 hover:bg-green-600 outline-0 font-bold rounded-lg text-sm px-5 py-2.5 text-lg">Place order</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
